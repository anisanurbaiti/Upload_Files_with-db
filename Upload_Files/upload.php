        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
                ...
                if ($conn->query($sql) === TRUE) {
                    echo "<script>alert('Berhasil Di Upload'); window.location=('download.php')</script>";
                } else {
               ...
               echo "<script>alert('Maaf Gagal Upload'); window.location=('index.php')</script>";
            }
        }
    } else {
        echo "<script>alert('Tidak ada file yang di Upload'); window.location=('index.php')</script>";
    }
}
?>
